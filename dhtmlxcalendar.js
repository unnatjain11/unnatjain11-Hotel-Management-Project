...
if (typeof window.dhx4 == "undefined") {
  window.dhx4 = {
    ...
    skinDetect: function (a) {
      return (
        { 10: "dhx_skyblue", 20: "dhx_web", 30: "dhx_terrace" }[
          this.readFromCss(a + "_skin_detect")
        ] || null
      );
    },
    ...
    _isObj: function (a) {
      return (
        a != null && typeof a == "object" && typeof a.length == "undefined"
      );
    },
    _copyObj: function (d) {
      if (this._isObj(d)) {
    ...
    transDetect: function () {
      if (this.transData == null) {
        ...
        for (var b in c) {
          if (
            this.transData.transProp == false &&
    ...
    _xmlNodeValue: function (a) {
      ...
      for (var b = 0; b < a.childNodes.length; b++) {
        c +=
          a.childNodes[b].nodeValue != null
            ? a.childNodes[b].nodeValue
                .toString()
                .replace(/^[\n\r\s]{0,}/, "")
                .replace(/[\n\r\s]{0,}$/, "")
            : "";
  ...
  window.dhx4.isIE6 =
    window.XMLHttpRequest == null && navigator.userAgent.indexOf("MSIE") >= 0;
  window.dhx4.isIE7 =
  ...
  window.dhx4.isChrome =
    navigator.userAgent.indexOf("Chrome") >= 0 && !window.dhx4.isEdge;
  window.dhx4.isKHTML =
  ...
  window.dhx4.dnd = {
    evs: {},
    p_en:
      (window.dhx4.isIE || window.dhx4.isEdge) &&
      (window.navigator.pointerEnabled || window.navigator.msPointerEnabled),
    _mTouch: function (a) {
      return (
        (window.dhx4.isIE10 && a.pointerType == a.MSPOINTER_TYPE_MOUSE) ||
        (window.dhx4.isIE11 && a.pointerType == "mouse") ||
        (window.dhx4.isEdge && a.pointerType == "mouse")
      );
    },
    _touchOn: function (a) {
      if (a == null) {
...
if (typeof window.dhx4.template == "undefined") {
  ...
  window.dhx4.template = function (b, c, a) {
    return b.replace(/#([a-z0-9_-]{1,})(\|([^#]*))?#/gi, function () {
      ...
      if (
        typeof h == "string" &&
        typeof window.dhx4.template[h] == "function"
      ) {
    ...
    for (var b = 0; b < u.length; b++) {
      switch (j[b]) {
        ...
        case "%F":
          var h = n(
            u[b].toLowerCase(),
            x[{ "%M": "monthShortName", "%F": "monthFullName" }[j[b]]]
          );
          if (h >= 0) {
            a.setMonth(h);
          }
        ...
        case "%h":
          if (!isNaN(u[b])) {
            ...
            if (t <= 12 && t >= 0) {
              a.setHours(
                t + (n("pm", u) >= 0 ? (t == 12 ? 0 : 12) : t == 12 ? -12 : 0)
              );
            }
          }
          break;
  ...
  window.dhx4.ajax = {
    ...
    xmltop: function (a, d, c) {
      if (typeof d.status == "undefined" || d.status < 400) {
        xml = !d.responseXML
          ? dhx4.ajax.parse(d.responseText || d)
          : d.responseXML || d;
    ...
    xpath: function (c, a) {
      ...
      if (dhx4.isIE) {
        ...
        var d = [];
        var g;
        var b = (a.ownerDocument || a).evaluate(
          c,
          a,
          null,
    ...
    _call: function (a, b, c, e, g, j, d) {
      var i =
        window.XMLHttpRequest && !dhx4.isIE
          ? new XMLHttpRequest()
      ...
      if (typeof n == "string") {
        ...
        if (m == null) {
          ...
          var i = function (a) {
            var k = null;
            if (
              (a.xmlDoc.getResponseHeader("Content-Type") || "").search(
                /xml/gi
              ) >= 0 ||
              a.xmlDoc.responseText.replace(/^\s{1,}/, "").match(/^</) != null
            ) {
        ...
        if (
          typeof n.documentElement == "object" ||
          (typeof n.tagName != "undefined" &&
            typeof n.getElementsByTagName != "undefined" &&
            n.getElementsByTagName(this._dhxdataload.xmlRootTag).length > 0)
        ) {
  ...
  dhtmlxValidation.prototype = {
    ...
    isValidEmail: function (a) {
      return !!a
        .toString()
        .match(
          /(^[a-z0-9]([0-9a-z\-_\.]*)@([0-9a-z_\-\.]*)([.][a-z]{3})$)|(^[a-z]([0-9a-z_\.\-]*)@([0-9a-z_\-\.]*)(\.[a-z]{2,4})$)/i
        );
    },
    ...
    isValidIPv4: function (a) {
      ...
      return (
        (b && !!(b[1] <= 255 && b[2] <= 255 && b[3] <= 255 && b[4] <= 255)) ||
        false
      );
    },
    isValidCurrency: function (a) {
      return (
        (a.toString().match(/^\$?\s?\d+?([\.,\,]?\d+)?\s?\$?$/) && true) ||
        false
      );
    },
...
dhtmlDragAndDropObject.prototype.callDrag = function (c) {
  ...
  if (
    ...
    if (a.pWindow && a.pWindow.dhtmlDragAndDrop.lastLanding) {
      a.pWindow.dhtmlDragAndDrop.lastLanding.dragLanding._dragOut(
        a.pWindow.dhtmlDragAndDrop.lastLanding
      );
    }
    if (_isIE) {
...
dhtmlDragAndDropObject.prototype.checkLanding = function (b, a) {
  if (b && b.dragLanding) {
    ...
    if (b && b.tagName != "BODY") {
      ...
      if (this.lastLanding) {
        this.lastLanding.dragLanding._dragOut(
          this.lastLanding,
          a.clientX,
          a.clientY,
          a
  ...
  if (!c) {
    ...
    if (a) {
      a.dragLanding._drag(
        ...
        a,
        _isIE ? event.srcElement : b.target
      );
    }
  }
  dragger.lastLanding = null;
...
dhtmlDragAndDropObject.prototype.initFrameRoute = function (c, d) {
  ...
  for (var a = 0; a < window.frames.length; a++) {
    try {
      if (window.frames[a] != c && window.frames[a].dhtmlDragAndDrop) {
        window.frames[a].dhtmlDragAndDrop.initFrameRoute(
          window,
          !c || d ? 1 : 0
        );
      }
...
if (typeof dhtmlxEvent.initTouch == "undefined") {
  dhtmlxEvent.initTouch = function () {
    ...
    dhtmlxEvent(document.body, "touchmove", function (f) {
      if (d) {
        if (
          Math.abs(f.touches[0].clientX - b) > 50 ||
          Math.abs(f.touches[0].clientY - a) > 50
        ) {
...
function dhtmlXCalendarObject(f, k) {
  ...
  if (
    ...
    typeof d == "object" &&
    d.tagName &&
    String(d.tagName).toLowerCase() != "input"
  ) {
    c = d;
  }
  d = null;
  ...
  for (var b = 0; b < f.length; b++) {
    ...
    if (
      f[b] != null &&
      f[b].tagName &&
      String(f[b].tagName).toLowerCase() == "input"
    ) {
      this.i[window.dhx4.newId()] = { input: f[b] };
    } else {
      if (
        !(f[b] instanceof Array) &&
        f[b] instanceof Object &&
        (f[b].input != null || f[b].button != null)
      ) {
  ...
  this.conf = {
    skin:
      ...
      window.dhx4.skinDetect("dhtmlxcalendar") ||
      "dhx_skyblue",
    ...
    if (this.msCont) {
      ...
      for (var l = 0; l < this.msCont.childNodes.length; l++) {
        for (var a = 0; a < this.msCont.childNodes[l].childNodes.length; a++) {
          this.msCont.childNodes[l].childNodes[a].innerHTML =
            this.langData[this.lang].monthesSNames[m++];
        }
      }
    }
  };
  ...
  j.onclick = function (n) {
    ...
    if (
      l.className &&
      l.className.indexOf("dhtmlxcalendar_month_arrow") === 0
    ) {
      e._hideSelector();
      ...
      e._drawMonth(
        new Date(
          e._activeMonth.getFullYear(),
          e._activeMonth.getMonth() + m,
          1,
          0,
          0,
          0,
    ...
    if (l.className && l.className == "dhtmlxcalendar_month_label_month") {
      ...
      e._showSelector(
        "month",
        Math.round(l.offsetLeft + l.offsetWidth / 2),
        l.offsetTop + l.offsetHeight + 2,
        "selector_month",
        true
      );
      return;
  ...
  this._drawDaysOfWeek = function () {
    ...
    for (var o = 0; o < 8; o++) {
      ...
      if (o == 0) {
        ...
        a.innerHTML =
          "<div class='dhtmlxcalendar_label'>" +
          (this.langData[this.lang].weekname || "w") +
          "</div>";
      } else {
        a.className =
          "dhtmlxcalendar_cell" +
          (l >= 6 ? " dhtmlxcalendar_day_weekday_cell" : "") +
          (o == 1 ? "_first" : "");
        a.innerHTML = m[l];
        if (++l > 7) {
          l = 1;
  ...
  this.contDates.onclick = function (p) {
    ...
    if (l._date != null && !l._css_dis) {
      ...
      var a =
        e._activeDate.getFullYear() + "_" + e._activeDate.getMonth() !=
        o.getFullYear() + "_" + o.getMonth();
      e._nullDate = false;
      e._activeDate = new Date(
        o.getFullYear(),
        o.getMonth(),
        o.getDate(),
        n,
      ...
      if (
        e._activeInp &&
        e.i[e._activeInp] &&
        e.i[e._activeInp].input != null
      ) {
        e.i[e._activeInp].input.value = e._dateToStr(
          new Date(e._activeDate.getTime())
        );
      }
      if (!e._hasParent) {
  ...
  this._clearDayHover = function (a) {
    ...
    if (a != null) {
      e._evOnMouseOut([
        new Date(
          this._lastHover._date.getFullYear(),
          this._lastHover._date.getMonth(),
          this._lastHover._date.getDate(),
          0,
          0,
          0,
          0
  ...
  j.innerHTML =
    "<div class='dhtmlxcalendar_time_img'></div><span class='dhtmlxcalendar_label_hours'></span><span class='dhtmlxcalendar_label_colon'> : </span><span class='dhtmlxcalendar_label_minutes'></span>";
  g.appendChild(j);
  j.onclick = function (m) {
    ...
    if (a.className && a.className == "dhtmlxcalendar_label_hours") {
      m.cancelBubble = true;
      var l =
        e.contMonth.offsetHeight +
        e.contDays.offsetHeight +
        e.contDates.offsetHeight +
        a.offsetTop;
      e._showSelector(
        "hours",
        Math.round(a.offsetLeft + a.offsetWidth / 2),
        l - 2,
        "selector_hours",
        true
      );
    ...
    if (a.className && a.className == "dhtmlxcalendar_label_minutes") {
      ...
      if (e._minutesInterval == 1) {
        ...
        a.innerHTML =
          "<span class='dhtmlxcalendar_selected_date'>" +
          n.charAt(0) +
          "</span>" +
          n.charAt(1);
  ...
  this._drawMonth = function (u) {
    ...
    for (var l = 0; l < 6; l++) {
      ...
      for (var A = 0; A <= 7; A++) {
        if (A == 0) {
          var z = this.getWeekNumber(
            new Date(s.getFullYear(), s.getMonth(), s.getDate() + p, 0, 0, 0, 0)
          );
          if (
            z >= 52 &&
            this.conf.ws_first == true &&
            this._activeMonth.getMonth() == 0
          ) {
            var o = this.getWeekNumber(
              new Date(
                s.getFullYear(),
                s.getMonth(),
                s.getDate() + p + 7,
          ...
          this.contDates.childNodes[l].childNodes[A].innerHTML =
            "<div class='dhtmlxcalendar_label'>" + z + "</div>";
        } else {
          var a = new Date(
            s.getFullYear(),
            s.getMonth(),
          ...
          if (this._tipData[n] != null) {
            if (
              this._tipData[n].usePopup &&
              typeof window.dhtmlXPopup == "function"
            ) {
              this.contDates.childNodes[l].childNodes[A].removeAttribute(
                "title"
              );
              this._initTooltipPopup();
            } else {
              this.contDates.childNodes[l].childNodes[A].setAttribute(
                "title",
                this._tipData[n].text
              );
            }
          ...
          this.contDates.childNodes[l].childNodes[A]._css_month =
            a.getMonth() == B;
          this.contDates.childNodes[l].childNodes[A]._css_date =
            !this._nullDate && n == C;
          this.contDates.childNodes[l].childNodes[A]._css_weekend = t >= 6;
          this.contDates.childNodes[l].childNodes[A]._css_dis =
            this._isOutOfRange(n);
          this.contDates.childNodes[l].childNodes[A]._css_holiday =
            this._holidays[n] == true;
  ...
  this._initSelector = function (s, n) {
    ...
    if (!this._sel) {
      ...
      this._sel.firstChild.firstChild.firstChild.appendChild(
      ...
      this._sel.firstChild.firstChild.firstChild.childNodes[2].innerHTML =
        "&nbsp;";
      this._sel.firstChild.firstChild.firstChild.childNodes[0].onmouseover =
        function () {
          this.className =
            "dhtmlxcalendar_selector_cell_left dhtmlxcalendar_selector_cell_left_hover";
        };
      this._sel.firstChild.firstChild.firstChild.childNodes[0].onmouseout =
        function () {
          this.className = "dhtmlxcalendar_selector_cell_left";
        };
      this._sel.firstChild.firstChild.firstChild.childNodes[2].onmouseover =
        function () {
          this.className =
            "dhtmlxcalendar_selector_cell_right dhtmlxcalendar_selector_cell_right_hover";
        };
      this._sel.firstChild.firstChild.firstChild.childNodes[2].onmouseout =
        function () {
      ...
      this._sel.onmouseover = function (v) {
        ...
        if (q._cell === true) {
          ...
          if (
            String(q.className).match(
              /^\s{0,}dhtmlxcalendar_selector_cell\s{0,}$/gi
            ) != null
          ) {
      ...
      this._sel.firstChild.firstChild.firstChild.childNodes[0].onclick =
        function (q) {
          q = q || event;
      ...
      this._sel.firstChild.firstChild.firstChild.childNodes[2].onclick =
        function (q) {
          q = q || event;
          if (q.type == "touchstart" && q.preventDefault != null) {
            q.preventDefault();
      ...
      if (this.conf.touch == true) {
        this._sel.firstChild.firstChild.firstChild.childNodes[0].ontouchstart =
          this._sel.firstChild.firstChild.firstChild.childNodes[0].onclick;
        this._sel.firstChild.firstChild.firstChild.childNodes[2].ontouchstart =
          this._sel.firstChild.firstChild.firstChild.childNodes[2].onclick;
      }
      this._sel._ta = {};
      this._selHover = null;
    ...
    if (s == "month") {
      ...
      this._sel.firstChild.firstChild.firstChild.childNodes[1].appendChild(
        this.msCont
      );
      var l = 0;
      for (var a = 0; a < 4; a++) {
      ...
      this.msCont.onclick = function (v) {
        ...
        if (q._month != null) {
          ...
          e._drawMonth(
            new Date(e._activeMonth.getFullYear(), q._month, 1, 0, 0, 0, 0)
          );
    ...
    if (s == "year") {
      ...
      this.ysCont.onclick = function (v) {
        ...
        if (q._year != null) {
          e._hideSelector();
          e._drawMonth(
            new Date(q._year, e._activeMonth.getMonth(), 1, 0, 0, 0, 0)
          );
          e._doOnSelectorChange();
        }
      };
  ...
  this._showSelector = function (o, l, p, n, a) {
    ...
    this._selCover.style.height =
      this.contDates.offsetHeight + this.contDays.offsetHeight - 1 + "px";
    this._selCover.style.display = "";
    this._sel._t = o;
    this._sel.className = "dhtmlxcalendar_selector_obj dhtmlxcalendar_" + n;
    this._sel.childNodes[0].firstChild.firstChild.childNodes[0].style.display =
      this._sel.childNodes[0].firstChild.firstChild.childNodes[2].style.display =
        o == "year" ? "" : "none";
    ...
    this._sel.childNodes[1].style.width =
      this._sel.childNodes[0].offsetWidth + "px";
  ...
  this._doOnSelectorChange = function (a) {
    this.callEvent("onChange", [
      new Date(
        ...
        this._activeMonth.getMonth(),
        this._activeDate.getDate(),
        this._activeDate.getHours(),
        this._activeDate.getMinutes(),
  ...
  this._clearSelHover = function () {
    ...
    this._selHover.className = String(
      this._selHover.className.replace(
  ...
  this._updateActiveMonth = function () {
    if (
      typeof this._msActive != "undefined" &&
  ...
  this._updateYearsList = function (p) {
    ...
    for (var o = 0; o < 4; o++) {
      for (var l = 0; l < 3; l++) {
        ...
        this.ysCont.childNodes[o].childNodes[l].className =
  ...
  this._scrollYears = function (a) {
    var m =
      (a < 0
        ? this.ysCont.firstChild.firstChild._year
        : this.ysCont.lastChild.lastChild._year) + a;
    var l = new Date(m, this._activeMonth.getMonth(), 1, 0, 0, 0, 0);
    this._updateYearsList(l);
  };
  this._updateActiveHours = function () {
    if (
      typeof this._hsActive != "undefined" &&
    ...
    if (this._strToDate != null) {
      for (var l in this.i) {
        if (this.i[l].input != null && this.i[l].input.value.length > 0) {
          var p = this._strToDate(
            this.i[l].input.value,
            this._dateFormat ||
    ...
    var m = String(this._dateFormat).replace(/%[a-zA-Z]+/g, function (a) {
      ...
      switch (q) {
        ...
        case "M":
          return (
            "(" +
            e.langData[e.lang].monthesSNames.join("|").toLowerCase() +
            "){1,}"
          );
        case "F":
          return (
            "(" +
            e.langData[e.lang].monthesFNames.join("|").toLowerCase() +
            "){1,}"
          );
        case "D":
          return "[a-z]{2}";
  ...
  this.getWeekNumber = function (p) {
    ...
    var o = v + 7;
    var u = 4;
    var m = new Date(p.getFullYear(), 0, 1, 0, 0, 0, 0);
    var n = m.getDay();
    if (n == 0) {
      n = 7;
    }
    ...
    var r = n - v;
    var t = new Date(p.getFullYear(), 0, 1 - r + s * 7, 0, 0, 0, 0);
    var x = 604800000;
    var l = new Date(
      p.getFullYear(),
      p.getMonth(),
    ...
    var w = Math.ceil((l.getTime() - t.getTime()) / x);
    if (w == 0) {
      var q = new Date(p.getFullYear(), p.getMonth(), p.getDate(), 0, 0, 0, 0);
      var a = q.getDay() - this._wStart;
      if (a < 0) {
        a = a + 7;
      }
      q.setDate(q.getDate() - a);
      w = this.getWeekNumber(q);
    }
    return w;
  };
  ...
  this.show = function (m) {
    ...
    if (
      typeof m == "object" &&
      typeof m._dhtmlxcalendar_uid != "undefined" &&
      this.i[m._dhtmlxcalendar_uid] == m
    ) {
  ...
  this._show = function (q, l) {
    ...
    if (!q) {
      ...
      if (this.pos == "right") {
        ...
        this.base.style.top =
          Math.min(p.top, r.bottom - this.base.offsetHeight) + "px";
      } else {
        if (this.pos == "bottom") {
  ...
  this._isOutOfRange = function (l) {
    ...
    if (this._rangeActive) {
      if (
        this._rangeType == "in" &&
        (l < this._rangeFrom || l > this._rangeTo)
      ) {
        return true;
      }
      if (
  ...
  this._initTooltipPopup = function () {
    ...
    this.attachEvent("onMouseOver", function (l) {
      ...
      if (this._tipData[a] != null) {
        ...
        this._tipTM = window.setTimeout(
          this._showTooltipPopup,
          this._tipTMTime
        );
      }
    });
    ...
    for (var o = 0; o < this.contDates.childNodes.length; o++) {
      for (var a = 0; a < this.contDates.childNodes[o].childNodes.length; a++) {
        ...
        if (r._date != null && r._date.getTime() == n) {
          l = {
            x: window.dhx4.absLeft(r),
            y: window.dhx4.absTop(r),
            w: r.offsetWidth,
            h: r.offsetHeight,
          };
        }
  ...
  this._doOnClick = function (l) {
    ...
    if (
      ...
      a._dhtmlxcalendar_uid != e._activeInp &&
      e._isVisible() &&
      e._activeInp
    ) {
      e._hide();
          ...
          if (m.button != null) {
            this.i[l].button =
              typeof m.button == "string"
                ? document.getElementById(m.button)
                : m.button;
          }
        }
      }
            ...
            if (m == null && n.input != null) {
              m = (
                typeof n.input == "string"
                  ? document.getElementById(n.input)
                  : n.input
              )._dhtmlxcalendar_uid;
            }
            if (m == null && n.button != null) {
              m = (
                typeof n.button == "string"
  ...
  this._attachEventsToObject = function (l) {
    if (this.i[l].button != null) {
      ...
      if (typeof window.addEventListener == "function") {
        ...
        if (this.conf.touch == true) {
          this.i[l].button.addEventListener(
            "touchstart",
            e._doOnBtnClick,
            false
          );
      ...
      if (this.i[l].input != null) {
        ...
        if (typeof window.addEventListener == "function") {
          ...
          if (this.conf.touch == true) {
            this.i[l].input.addEventListener(
              "touchstart",
              e._doOnInpClick,
              false
            );
  ...
  this._detachEventsFromObject = function (l) {
    if (this.i[l].button != null) {
      if (typeof window.addEventListener == "function") {
        ...
        if (this.conf.touch == true) {
          this.i[l].button.removeEventListener(
            "touchstart",
            e._doOnBtnClick,
            false
          );
      ...
      if (this.i[l].input != null) {
        if (typeof window.addEventListener == "function") {
          ...
          if (this.conf.touch == true) {
            this.i[l].input.removeEventListener(
              "touchstart",
              e._doOnInpClick,
              false
            );
  ...
  this.unload = function () {
    ...
    while (this.contDates.childNodes.length > 0) {
      while (this.contDates.lastChild.childNodes.length > 0) {
        ...
        this.contDates.lastChild.removeChild(
          this.contDates.lastChild.lastChild
        );
      }
    ...
    if (this._sel) {
      ...
      this._sel.firstChild.firstChild.removeChild(
...
dhtmlXCalendarObject.prototype._buildMonthHdr = function (e) {
  ...
  var a = function (f, g) {
    return (
      "<span class='dhtmlxcalendar_month_label_" + f + "'>" + g + "</span>"
    );
  };
    ...
    if (!this._ifr) {
      ...
      this._ifr.onload = function () {
        ...
        this.contentWindow.document.write(
          "<html><head><style>html,body{width:100%;height:100%;overflow:hidden;margin:0px;}</style></head><body</body></html>"
        );
      };
...
window.dhtmlxDblCalendarObject =
  window.dhtmlXDoubleCalendarObject =
  window.dhtmlXDoubleCalendar =
    function (b) {
      var a = this;
      ...
      this.show = function () {
        ...
        this.rightCalendar.base.style.marginLeft =
          this.leftCalendar.base.offsetWidth - 1 + "px";
      ...
      this._updateRange = function (c, e, d) {
        if (arguments.length == 3) {
          (c == "leftCalendar"
            ? this.leftCalendar
            : this.rightCalendar
          ).setSensitiveRange(e, d);
        } else {
          this.leftCalendar.setSensitiveRange(
            null,
            this.rightCalendar.getDate()
          );
          this.rightCalendar.setSensitiveRange(
      ...
      this.getFormatedDate = function () {
        return this.leftCalendar.getFormatedDate.apply(
          this.leftCalendar,
          arguments
        );
      };
